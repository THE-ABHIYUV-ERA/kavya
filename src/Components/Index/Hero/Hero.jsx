...
const SmartAttendance = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 
        bg-gradient-to-br dark:from-blue-50 dark:to-indigo-100 from-gray-900 to-gray-800 transition-all duration-1000">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-8 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center">
            ...
            <p className="text-2xl sm:text-3xl font-light mb-6 text-gray-300 dark:text-gray-600">
              Made <span className="font-semibold text-sky-500 dark:text-yellow-400">Easy!</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <button className="px-6 py-3 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg shadow-md 
                  hover:shadow-md transition-all duration-300 transform hover:scale-105 focus:outline-none">
                Get Started
              </button>
              <button className="px-6 py-3 border-2 border-sky-500 text-sky-500 hover:bg-none dark:hover:bg-none 
                  dark:text-sky-400 dark:border-sky-400 font-medium rounded-lg shadow-md 
                  hover:shadow-md hover:scale-105 transition-all duration-300 focus:outline-none">
                Learn More
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative overflow-hidden">
            {/* Decorative Elements */}
            <div className="absolute top-0 left-0 w-32 h-32 bg-blue-300 dark:bg-indigo-600 rounded-full opacity-20 
                -translate-x-16 -translate-y-16"></div>
            <div className="absolute bottom-0 right-0 w-48 h-48 bg-indigo-300 dark:bg-indigo-800 rounded-full opacity-20 
                translate-x-16 translate-y-16"></div>

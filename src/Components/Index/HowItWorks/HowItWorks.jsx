  ...
  const steps = [
    {
      ...
      description: "Sign up as an admin or teacher to manage your college’s attendance.",
    },
    {
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between space-y-12 md:space-y-0 md:space-x-12">
          {steps.map((step, index) => (
            <div key={index} className="relative flex flex-col items-center text-center max-w-xs">
              <div className="bg-gray-700 dark:bg-white p-6 rounded-full shadow-lg transition-transform transform hover:scale-110 duration-300">
                {step.icon}
              </div>

      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            <li><a href="#about" className="text-gray-400 no-underline hover:underline hover:text-white transition">Roles</a></li>
            <li><a href="#features" className="text-gray-400 no-underline hover:underline hover:text-white transition">Challenges?</a></li>
            <li><a href="#pricing" className="text-gray-400 no-underline hover:underline hover:text-white transition">Experience</a></li>
            <li><a href="#faq" className="text-gray-400 no-underline hover:underline hover:text-white transition">Analytics</a></li>
          </ul>
        </div>
